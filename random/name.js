...
const syllables = ['acaru', 'achi', 'acti', 'ael', 'aelle', 'aelo', 'aer', 'aeri', 'aero',
  ...
  'anke', 'anse', 'anti', 'aol', 'aqua', 'arae', 'arc', 'argo', 'aria', 'ariel', 'aries', 'arius', 'arje', 'arrow', 'arti', 'arvel', 'aryn', 'ash', 'astri', 'athen',
  'aukh', 'aura', 'axe', 'axna', 'az', 'azo', 'azri', 'azu', 'azure', 'bag', 'bain', 'bais', 'bando', 'bane', 'baph', 'bard', 'baro', 'baron', 'bat', 'battle', 'beef',
  'ber', 'bear', 'bhol', 'bhul', 'bik', 'bird', 'bith', 'blade', 'blaze', 'bloch', 'blok', 'blood', 'bloom', 'bo', 'boink', 'bokh', 'bomb', 'bone', 'bonk', 'bore', 'borne',
  'boro', 'bound', 'bow', 'brain', 'brass', 'brie', 'brir', 'bris', 'broke', 'bry', 'bryr', 'bubble', 'bugo', 'caen', 'calm', 'canis', 'cape', 'capri', 'carp', 'cary',
  'cassi', 'cat', 'cavi', 'celo', 'cern', 'charm', 'chea', 'chef', 'cherry', 'ciea', 'cili', 'cill', 'ciri', 'claw', 'clear', 'cone', 'contra', 'copi', 'corba', 'corn', 'cold', 
  ...
  'dhai', 'dhar', 'dhrar', 'dhug', 'dhyl', 'dia', 'dieri', 'dio', 'doe', 'dog', 'dohr', 'doom', 'dorr', 'down', 'drae', 'drakh', 'drakk', 'dre', 'drea', 'dread', 'dream',
  'drop', 'dryd', 'dryn', 'dryr', 'duin', 'duirn', 'duke', 'duo', 'dusk', 'dy', 'dya', 'dyas', 'dysra', 'eago', 'eal', 'earl', 'eas', 'echo', 'ecto', 'edo', 'eevo', 'egg',
  ...
  'flame', 'flesh', 'flock', 'foe', 'fois', 'fous', 'fray', 'frost', 'fulvu', 'fume', 'fur', 'fyn', 'fyr', 'fyre', 'gabo', 'gaia', 'galaz', 'gali', 'galo', 'gami', 'gamma',
  ...
  'heis', 'hek', 'hell', 'helm', 'hera', 'hercu', 'heria', 'hex', 'hexa', 'hexi', 'hexo', 'hole', 'hong', 'horn', 'horo', 'howl', 'hydra', 'hysta', 'iar', 'ice', 'ida',
  ...
  'kar', 'kash', 'kaz', 'kei', 'kery', 'key', 'khad', 'khon', 'khuza', 'khyr', 'klee', 'knod', 'kom', 'kotr', 'krata', 'kreo', 'krono', 'kuhr', 'kuvok', 'kwyl', 'kyri',
  ...
  'lock', 'lofty', 'loi', 'lone', 'lore', 'love', 'low', 'lozz', 'lua', 'luim', 'lumo', 'luna', 'lush', 'lust', 'lya', 'lymph', 'lynx', 'lyre', 'lys', 'lyvi', 'mae', 'mage',
  'magi', 'magno', 'maie', 'major', 'mali', 'malo', 'manca', 'mane', 'mango', 'marco', 'marrow', 'marsh', 'max', 'medi', 'medu', 'meen', 'mel', 'melia', 'mell', 'melng',
  'melon', 'meph', 'merc', 'mese', 'meso', 'metal', 'miki', 'mince', 'mini', 'miri', 'misia', 'mistra', 'mizu', 'mmior', 'mo', 'mock', 'moi', 'moor', 'more', 'morgh', 'morja',
  'morl', 'moss', 'moza', 'mozo', 'mroer', 'mua', 'muami', 'mug' 'mugg', 'muku', 'mulae', 'muno', 'muo', 'mutt', 'muzor', 'mydra', 'myr', 'myri', 'myth', 'nae', 'nai', 'nail',
  'nando', 'nari', 'naul', 'nava', 'naz', 'neazu', 'ned', 'neia', 'neme', 'nemo', 'neo', 'nera', 'nero', 'night', 'nill', 'niroi', 'nise', 'niye', 'nobnar', 'noi', 'nose',
  'nox', 'noxi', 'nua', 'nuanyi', 'nuck', 'nuk', 'numzu', 'nye', 'nyel', 'nymph', 'nyri', 'nyx', 'oah', 'oak', 'ocea', 'ocia', 'oat', 'octa', 'octo', 'odd', 'odin', 'odio', 'odis',
  'odru', 'oghm', 'ogu', 'oia', 'oisse', 'ola', 'olg', 'olle', 'omni', 'oni', 'only', 'onty', 'ophe', 'ophi', 'opi', 'orb', 'orc', 'ordi', 'ore', 'orio', 'orlo', 'ouch',
  ...
  'pilia', 'pine', 'piol', 'piuc', 'pluto', 'poe', 'pore', 'pox', 'prae', 'prio', 'pseu', 'psy', 'purla', 'py', 'pyro', 'pytho', 'pyxi', 'qaas', 'qae', 'qama', 'qas', 'qash',
  ...
  'reve', 'rhor', 'rhya', 'riad', 'riel', 'rienn', 'rift', 'rine', 'ring', 'rio', 'rismo', 'rissa', 'riznu', 'roar', 'rock', 'roe', 'rof', 'rog', 'rol', 'roll', 'rolu',
  'rori', 'rose', 'rosi', 'roth', 'rune', 'runi', 'ruth', 'rya', 'ryas', 'rym', 'rynn', 'ryo', 'sael', 'saew', 'sai', 'sale', 'salt', 'salty', 'sarya', 'sau', 'sauce',
  'sauth', 'scar', 'sces', 'schi', 'scorp', 'scum', 'sea', 'see', 'seir', 'sela', 'semi', 'seus', 'shade', 'shard', 'shear', 'shemu', 'shie', 'shine', 'shrub', 'sia', 'sie',
  ...
  'thro', 'thry', 'thual', 'thuen', 'thye', 'thyn', 'tia', 'tiara', 'tiik', 'tilre', 'tima', 'timni', 'to', 'tona', 'tone', 'tor', 'toxi', 'tree', 'tri', 'trila', 'tris',
  'triss', 'trith', 'trog', 'troll', 'trove', 'true', 'tryl', 'tusk', 'tusso', 'tuts', 'tyr', 'tyra', 'ues', 'ugly', 'ui', 'uie', 'uipho', 'ujuy', 'uku', 'ulvu', 'under',
  'uni', 'uozi', 'up', 'urlu', 'uro', 'us', 'uth', 'utha', 'utta', 'uugu', 'uvy', 'vaal', 'vae', 'vaen', 'vaez', 'vain', 'vang', 'varo', 'varr', 'vat', 'vayne', 'vazu',
  'veba', 'veda', 'veni', 'vephie', 'vesla', 'veth', 'vigo', 'virgo', 'vitro', 'vizi', 'voda', 'void', 'vois', 'volno', 'volo', 'volt', 'vomi', 'vonth', 'vord', 'vors',
